'''
import predict
args.cifpath=data/test
args.modelpath=pre-trained/formation-energy.pth.tar
'''
import argparse
import os
import shutil
...
parser.add_argument('C:/Users/96913/cgcnn-master/pre-trained/formation-energy.pth.tar', help='path to the trained model.')
parser.add_argument('C:/Users/96913/cgcnn-master/data/test', help='path to the directory of CIF files.')
